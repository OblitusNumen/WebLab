<template>
  <div class="markdown">
    ...
    <p>Наш сайт использует файлы cookie для улучшения пользовательского опыта. Вы можете настроить параметры
      использования cookie в вашем браузере.</p>
    <h3>8. <strong>Изменения политики конфиденциальности</strong></h3>
    <p>Мы оставляем за собой право изменять настоящую Политику конфиденциальности. Изменения вступают в силу с момента
      публикации новой версии на сайте.</p>
